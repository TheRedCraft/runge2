										...
										children: o(t.div, {
											...
											children: [
												...
												e(d, {
													className:
														'Contact-container',
														rawHTML: `<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; height: 100%; width: 100%; background-color: black;">
														<input
															style="width: 60%; margin: 1rem; height: 5rem; border-radius: 15px; padding: 5px; background-color: #353535; border: none;"
															placeholder="Name"
															type="text"
															class="in1" /><input
															style="width: 60%; margin: 1rem; height: 5rem; border-radius: 15px; padding: 5px; background-color: #353535; border: none;"
															...
															type="text"
															class="in1" /><input
															style="width: 60%; margin: 1rem; height: 13rem; border-radius: 15px; padding: 5px; background-color: #353535; border: none;"
															placeholder="Message"
															type="text"
															class="in1" /><input
															value="SEND"
